 ...
 */
#ifndef MXNET_MY_PREDICT_API_H_
#define MXNET_MY_PREDICT_API_H_
 ...
 */
MXNET_DLL const char* MYGetLastError();
 ...
 */
MXNET_DLL int MYPredCreate(const char* symbol_json_str,
...
MXNET_DLL int MYPredCreatePartialOut(const char* symbol_json_str,
                                     const void* param_bytes,
                                     int param_size,
                                     int dev_type, int dev_id,
                                     mx_uint num_input_nodes,
 ...
 * \return 0 when success, -1 when failure.
 */
MXNET_DLL int MYPredReshape(PredictorHandle handle,
                            const mx_uint* input_shape_data);
MXNET_DLL int MYPredGetOutputShape(PredictorHandle handle,
                                   mx_uint index,
                                   mx_uint** shape_data,
                                   mx_uint* shape_ndim);
/*!
 ...
 * \return 0 when success, -1 when failure.
 */
MXNET_DLL int MYPredSetInput(PredictorHandle handle,
                             const char* key,
                             const mx_float* data,
                             mx_uint size);
/*!
 ...
 * \return 0 when success, -1 when failure.
 */
MXNET_DLL int MYPredForward(PredictorHandle handle);
/*!
 ...
 * \return 0 when success, -1 when failure.
 */
MXNET_DLL int MYPredPartialForward(PredictorHandle handle, int step, int* step_left);
/*!
 ...
 * \return 0 when success, -1 when failure.
 */
MXNET_DLL int MYPredGetOutput(PredictorHandle handle,
                              mx_uint index,
                              mx_float* data,
                              mx_uint size);
/*!
 ...
 * \return 0 when success, -1 when failure.
 */
MXNET_DLL int MYPredFree(PredictorHandle handle);
/*!
 ...
 * \return 0 when success, -1 when failure.
 */
MXNET_DLL int MYNDListCreate(const char* nd_file_bytes,
                             int nd_file_size,
                             NDListHandle *out,
                             mx_uint* out_length);
/*!
 ...
 * \return 0 when success, -1 when failure.
 */
MXNET_DLL int MYNDListGet(NDListHandle handle,
                          mx_uint index,
                          const char** out_key,
 ...
 * \return 0 when success, -1 when failure.
 */
MXNET_DLL int MYNDListFree(NDListHandle handle);

#ifdef __cplusplus
}
#endif  // __cplusplus

#endif  // MXNET_MY_PREDICT_API_H_
