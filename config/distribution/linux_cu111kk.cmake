...
set(CUDACXX "/usr/local/cuda/bin/nvcc" CACHE STRING "Cuda compiler")
set(MXNET_CUDA_ARCH "7.5;8.6" CACHE STRING "Cuda architectures")
set(CUDNN_INCLUDE "/home/bluews/dev/cudnn/include" CACHE PATH "")
set(CUDNN_LIBRARY "/home/bluews/dev/cudnn/lib64/libcudnn.so" CACHE PATH "")
set(NCCL_INCLUDE_DIRS "/home/bluews/dev/nccl/include" CACHE PATH "")
set(NCCL_LIBRARIES "/home/bluews/dev/nccl/lib/libnccl.so" CACHE PATH "")
set(USE_DIST_KVSTORE ON CACHE BOOL "")